...
2. For each scenario in `skill-routing-benchmark.md`, ask the agent which skill(s) and command(s) it would use.
...
Record agent responses and scoring in your team’s QA tracker or PR checklist when changing skill names or command routes.
